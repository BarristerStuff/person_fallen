...
MANIFESTS = {"dev": ROOT / "manifests/dev_canary.csv", "screen": ROOT / "manifests/targeted_regression_crop.csv", "val": ROOT / "manifests/val_operational_crop.csv"}
DETECTOR_SUMMARIES = {}
ATTRIBUTE_KEYS = [
...
def main() -> int:
    ...
    run_dir = ROOT / "eval/runs" / f"{args.phase}_REV15"
