...
## P4D GR3Q9 — hard-negative balanced stable window

Q9 independently verified the Q8 parent freeze and rebuilt the 440-slot partition as 196 verified success, one completion-unknown quarantine, and 243 safe executable outstanding. Its frozen 30-slot plan used 25 hard-negative and 5 positive slots, NEW_DESIGN=15 and NEW_SCREEN=15, across six complete groups (curled positive, ground maintenance, squat, crawling, pushup/plank, mixed); `MAINT_G006` remained excluded. Plan SHA-256 is `0344c97847ea7447fee7246a7dc9b173429efd058aa0f4153eb9d2f6d5bb950c`.

The independent Q9 `_02` execution completed exactly 30/30 logical invocations at the authorized cap: HTTP200=30, success=30, physical lower-bound=30, native retry events=0, policy refusals=0, and zero 429/401/403/5xx, timeout, network, or other provider failures. No 31st request was sent. It produced 30 raw and 30 final images. Mechanical QA passed with zero Pillow failures, final dimension failures, exact duplicates, GR1 SHA hits, or foreign-event assets. Native output was `1672x941` for all requests despite requested `1536x1024`; finals were `1920x1080`.

The run is preserved as generation evidence but not marked as a clean formal Q9 freeze: `01_authorization/authorization.json` contains inherited Q8 cap metadata (25 logical / 30 physical), while the actual Q9 runner enforced 30 / 36. This material post-run configuration-binding mismatch is recorded in the revision-local audit and final report; no historical artifact was rewritten and no further provider request was made. `P4D_IMAGES_ACCEPTED=0` remains unchanged. The post-run partition is 226 verified success, one completion-unknown quarantine, and 213 safe executable outstanding. Dataset validation remained valid, 0 errors, full-hash=true, 387 historical warnings, with active P4D references=0. There was no formal ingest, C3, VAL, HOLDOUT, production, or Ollama operation. See [115 preflight](/home/yanbo/net_vlm_person_fallen_v2_optimization/reports/115_p4d_gr3q9_preflight.md), [116 plan](/home/yanbo/net_vlm_person_fallen_v2_optimization/reports/116_p4d_gr3q9_balanced_30_plan.md), [117 execution](/home/yanbo/net_vlm_person_fallen_v2_optimization/reports/117_p4d_gr3q9_execution.md), [118 QA](/home/yanbo/net_vlm_person_fallen_v2_optimization/reports/118_p4d_gr3q9_partial_qa.md), and [119 final](/home/yanbo/net_vlm_person_fallen_v2_optimization/reports/119_p4d_gr3q9_final.md).
